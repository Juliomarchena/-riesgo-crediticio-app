        ...
        children: [
          ...
          new Table({
            ...
            rows: [
              ...
              makeRow("Cuota Mensual", formData?.installment ? `$${Number(formData.installment).toFixed(2)}` : "-", true),
              makeRow("Ingreso Anual Aprox.", formData?.log_annual_inc ? `$${Math.round(Math.exp(formData.log_annual_inc)).toLocaleString("es-PE")}` : "-", false),
